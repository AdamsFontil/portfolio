    ...
    <div className="flex">
      <div className='flex justify-center items-center flex-col md:flex-row'>
        ...
        <div className=' text-white p-5 flex flex-col gap-2'>
          <h1 className='text-2xl md:text-4xl text-cyan-200'>About Me</h1>
          ...
          <p>Thank you for taking the time to read my profile, like really. I'm excited to connect with you. If you're interested in contacting me, please visit my contact section to find my professional accounts and resume. I'm actively seeking an entry-level web development position and welcome any feedback and opportunities.</p>
          <div className='flex text-cyan-200 justify-end gap-2'>
