    ...
    <div className='p-4 flex flex-col gap-2'>
      ...
      <div className='grid grid-cols-1 gap-3 md:grid-cols-3 '>
        {projectsData.map((project, index) => (
          <div className=' border-orange-200 rounded-lg border-2 text-black' key={index}>
            <img className='w-100vh object-contain border-2 ' src={project.screenshot} alt={project.name} />
            <div className='p-4'>
              <div className='flex items-center justify-between text-orange-200'>
                ...
                <div className='flex gap-2 justify-end'>
                  ...
                  <FontAwesomeIcon icon={faArrowUpRightFromSquare} className='hover:text-white'   />
                </div>
              </div>
